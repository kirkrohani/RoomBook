					...
					<div class="footer-sidebar row">
						...
						<div class="col-md-4 col-sm-6 widget">
							...
							<ul class="clean-list contact-info text-dark-blue uppercase">
								<li><i class="icon-338 font-2x"></i> <b>Address: </b> Dallas, TX 75251</li>
								<li><i class="icon-274 font-2x"></i> <b>E-mail: </b> <a href="mailto:kirk.rohani@gmail.com">kirk.rohani@gmail.com</a></li>
								<li><i class="icon-274 font-2x"></i> <b>E-mail: </b> <a href="mailto:kirk.rohani@gmail.com">kirk.rohani@gmail.com</a></li>
								<li><i class="icon-402 font-2x"></i> <b>Phone: </b> (214)555-5555</li>
								<li><i class="icon-402 font-2x"></i> <b>Phone: </b> (214)555-5555</li>
							</ul>
						</div>
						
						<div class="col-md-4 col-sm-6 widget post-widget">
							<h4>Follow RoomBook</h4>
